...
const ShoppingCart = () => {
    return (
        <section
        className=" relative z-10 after:contents-[''] after:absolute after:z-0 after:h-full xl:after:w-1/3 after:top-0 after:right-0 dark:after:bg-gray-700 after:bg-gray-50">
            ...
            <div className="grid grid-cols-12">
                <div
                    ...
                    <div className="flex items-center justify-between pb-8 border-b border-gray-300">
                        ...
                        <h2 className="font-manrope font-bold text-3xl leading-10 text-black dark:text-white ">3 Items</h2>
                    </div>
                ...
                {/* // Single Shopping Item  */}
                    ...
                    <div className="flex items-center justify-end mt-8">
                        <button
                            className="flex items-center px-5 py-3 rounded-full gap-2 border-none outline-0 font-semibold text-lg leading-8 text-indigo-600 shadow-sm shadow-transparent transition-all duration-500 hover:shadow-indigo-300 hover:bg-indigo-50 dark:hover:text-indigo-600 dark:text-indigo-300">
                            Add Coupon Code
